...
1. [Названия переменных](#Названия переменных)
2. [Отступы в коде](#Отступы в коде)
3. [Разбиение кода на функции](#Разбиение кода на функции)
4. [Правильное написание функций](#Правильное написание функций)
